/*
Responsive Web Design Projects - Product Landing Page (project 003)

PROJECT LESSONS:
- Leverage media query to hide images and center text for better mobile viewing. 
- Fixed header that moves when the user scrolls. Also using a margin of 0 in body element so header doesn't have top space when scrolling. 
